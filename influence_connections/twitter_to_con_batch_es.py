...
for tweet_date in daterange(start_date, end_date):
	start_date = tweet_date.strftime('%a, %d %b %Y %H:%M:%S +0000')
	end_date = tweet_date.strftime('%a, %d %b %Y 23:59:59 +0000')

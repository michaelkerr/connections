...
start_date = int((datetime.date(2013, 1, 01) - datetime.datetime(1970, 1, 1)).total_seconds())
#end_date = datetime.date(2014, 1, 27)
end_date = int((datetime.date(2014, 1, 27) - datetime.datetime(1970, 1, 1)).total_seconds())
